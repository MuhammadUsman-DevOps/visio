    ...
    init: function () {
        ...
        !function () {
            if (document.querySelector("#kt_dashboard_daterangepicker")) {
                var e = $("#kt_dashboard_daterangepicker"), t = moment(), a = moment();
                e.daterangepicker({
            ...
            e && new ApexCharts(e, {
                series: [{name: "Measured Temp", data: [30, 40, 40, 90, 90, 70, 70]}],
            ...
            var e = document.getElementById("kt_charts_widget_7_chart"), t = parseInt(KTUtil.css(e, "height")),
                ...
                i = KTUtil.getCssVariableValue("--bs-light-warning"), l = KTUtil.getCssVariableValue("--bs-success"),
            ...
            [].slice.call(t).map((function (t) {
                e = parseInt(KTUtil.css(t, "height")), new ApexCharts(t, {
                    ...
                    fill: {type: ["solid", "solid"], opacity: [.25, 1]},
                    states: {
                        normal: {filter: {type: "none", value: 0}},
                        hover: {filter: {type: "none", value: 0}},
                        active: {allowMultipleDataPointsSelection: !1, filter: {type: "none", value: 0}}
            ...
            var e = document.getElementById("kt_charts_mixed_widget_16_chart"), t = parseInt(KTUtil.css(e, "height"));
            if (e) {
                var a = {
            ...
            var e = document.getElementById("kt_charts_mixed_widget_18_chart"), t = parseInt(KTUtil.css(e, "height"));
            if (e) {
                var a = KTUtil.getCssVariableValue("--bs-gray-800"), o = KTUtil.getCssVariableValue("--bs-gray-800"),
            ...
            var e = document.getElementById("kt_charts_mixed_widget_19_chart"), t = parseInt(KTUtil.css(e, "height"));
            if (e) {
                var a = KTUtil.getCssVariableValue("--bs-gray-800"), o = KTUtil.getCssVariableValue("--bs-info"),
                    s = KTUtil.getCssVariableValue("--bs-light-info");
                new ApexCharts(e, {
                    series: [{name: "Net Profit", data: [30, 25, 45, 30, 55, 55]}],
                    chart: {
            ...
            if ("undefined" != typeof FullCalendar && document.querySelector("#kt_calendar_widget_1")) {
                var e = moment().startOf("day"), t = e.format("YYYY-MM"),
                    a = e.clone().subtract(1, "day").format("YYYY-MM-DD"), o = e.format("YYYY-MM-DD"),
