...
var KTProjectOverview = function () {
    var t = KTUtil.getCssVariableValue("--bs-primary"), e = KTUtil.getCssVariableValue("--bs-light-primary"),
        a = KTUtil.getCssVariableValue("--bs-success"), r = KTUtil.getCssVariableValue("--bs-light-success"),
        o = KTUtil.getCssVariableValue("--bs-gray-200"), n = KTUtil.getCssVariableValue("--bs-gray-500");
    return {
        init: function () {
            var s, i;
            !function () {
                ...
                }, {name: "Minimum", data: [55, 55, 60, 60, 55, 55, 60]}],
                ...
                a.addEventListener("change", (function (t) {
                    ...
                    var r = o, s = n, i = parseFloat(moment(e[1]).format()) || 0;
